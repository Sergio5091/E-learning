...
<template>
  ...
  <div class="hidden lg:block fixed right-0 top-0 h-full w-16 z-20">
    ...
    <!-- Hero Section -->
  <section class="relative flex flex-col md:flex-row items-center justify-between py-10 px-3 sm:px-6 md:px-12 lg:px-32 mb-8 gap-8">
      <div class="flex-1 z-10">
        <h1 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-blue-500 dark:text-white mb-4 drop-shadow-lg">
          Plateforme E-Learning Moderne
        </h1>
  <p class="text-base sm:text-lg md:text-xl text-gray-700 dark:text-gray-200 mb-6 max-w-xl">
          {{ objectif }}
        </p>
  <span class="inline-block px-3 py-2 bg-blue-500 dark:bg-blue-400 text-white rounded-full font-semibold shadow-lg animate-bounce text-sm sm:text-base">
          🖥🖥 Rejoignez-nous dès aujourd'hui !
        </span>
      </div>
      <!-- Slider d'images -->
      <div class="flex-1 flex items-center justify-center mt-6 md:mt-0">
        <div class="relative w-56 h-40 sm:w-64 sm:h-44 md:w-72 md:h-56 overflow-hidden rounded-2xl shadow-2xl border-4 border-blue-100 dark:border-gray-400 bg-white dark:bg-black">
  ...
  <h2 class="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-blue-600 dark:text-white text-center tracking-tight">
        Nos Formateurs
      </h2>
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-8">
        <div
          ...
          :key="instructor.name"
          class="bg-white dark:bg-neutral-900 rounded-2xl shadow-xl p-4 sm:p-6 border-t-4 border-blue-200 dark:border-white hover:scale-105 transition-transform duration-300"
        >
    ...
    <!-- Section Promos -->
    <section
      class="max-w-5xl mx-auto px-2 sm:px-4 py-8 sm:py-12 mt-6 sm:mt-10 rounded-2xl sm:rounded-3xl bg-neutral-100 dark:bg-neutral-300 shadow-2xl flex flex-col items-center justify-center relative overflow-hidden border border-blue-100 dark:border-blue"
    >
  <h3 class="text-lg sm:text-2xl md:text-3xl font-extrabold text-blue-700 dark:text-neutral-800 mb-3 sm:mb-4 drop-shadow-lg">
        🎉 Promotions & Réductions à venir !
      </h3>
  <p class="text-base sm:text-lg text-gray-700 dark:text-neutral-600 mb-4 sm:mb-6 text-center max-w-2xl">
      ...
      <span
        class="inline-block px-4 py-2 bg-blue-600 dark:bg-blue-400 text-white font-bold rounded-full shadow-lg animate-pulse text-sm sm:text-base"
      >
        Bientôt disponible !
      </span>
    </section>
